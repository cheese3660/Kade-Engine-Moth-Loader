...
![Mothical Logo](assets/preload/images/MothLogo.png)

# Friday Night Funkin': Kade Engine & Moth Loader
## Friday Night Funkin'
...
## Moth Loader
**Moth Loader** is a mod of Kade Engine which in itself is a mod of Friday Night Funkin' that allows for easy modding of the game without recompilation every time.

# Features
 - **Less Hardcoding**
 	- Many things that were hardcoded in FNF, such as character animations, are moved out to JSON files and the code is changed to load that
 - **Easy Modding**
 	- Moth Loader also adds a mod loader to Friday Night Funkin' that looks for mods in the mods folder, it currently only supports adding characters/character overrides
...
### Moth Loader
- Cheese
- [The contributors](https://github.com/cheese3660/Kade-Engine-MothLoader/graphs/contributors)
